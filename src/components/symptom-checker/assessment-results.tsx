  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <motion.div
        ...
        className="max-w-2xl lg:max-w-3xl mx-auto space-y-4 sm:space-y-6 px-4 sm:px-6 py-4 sm:py-6"
      >
        ...
        <AnimatePresence>
          {result.emergencyWarning && (
            ...
            >
              <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-0 shadow-xl rounded-xl overflow-hidden border-l-4 border-l-red-500">
                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                          <Button 
                            variant="destructive" 
                            className="w-full h-10 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-lg font-semibold text-sm shadow-lg"
                        ...
                        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                          <Button 
                            variant="outline" 
                            className="w-full h-10 border-2 border-red-300 bg-white/80 hover:bg-red-50 rounded-lg font-semibold text-sm"
        ...
        >
          <Card className="bg-gradient-to-br from-white to-gray-50 border-0 shadow-xl rounded-xl overflow-hidden">
            ...
            <CardContent className="p-4 sm:p-6 space-y-4 sm:space-y-6">
              ...
              <motion.div 
                ...
                className={`p-4 rounded-xl border-0 shadow-lg ${getSeverityColor(result.severity)} bg-gradient-to-r`}
              >
                      ...
                      {result.possibleConditions
                        ...
                        .map((condition, index) => (
                          <motion.div
                            ...
                            className="bg-gradient-to-r from-white to-blue-50 p-4 rounded-xl border-0 shadow-lg hover:shadow-xl transition-all duration-300"
                          >
                            <div className="flex justify-between items-start mb-2">
                              <h4 className="font-bold text-base text-gray-900">{condition.name}</h4>
                              <div className="text-right">
                                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent font-bold text-base">
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-green-50 to-blue-50 p-4 rounded-xl border-0"
              >
                <div className="flex items-center space-x-3 mb-4">
              ...
              <motion.div
                ...
                className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border-0"
              >
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button 
                    ...
                    className="w-full h-10 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-lg font-semibold text-sm shadow-lg"
                  >
