      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <Card className="bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl">
              <CardContent className="p-8">
                <h2 className="heading-xl text-gray-900 mb-6">Send us a Message</h2>
          ...
          >
            ...
            <Card className="bg-white/80 backdrop-blur-sm border border-white/20 shadow-xl">
              <CardContent className="p-8">
                <h2 className="heading-xl text-gray-900 mb-6">Get in Touch</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@medicalai.com</p>
                      <p className="text-gray-600">partnerships@medicalai.com</p>
                    </div>
                  </div>
            ...
            <Card className="bg-red-50 border border-red-200">
              <CardContent className="p-6">
                ...
                <p className="text-red-800 text-sm mb-4">
                  ...
                  or go to your nearest emergency room. Do not use this contact form for urgent medical issues.
                </p>
